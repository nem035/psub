...
const __topicToSubscriptionsMap__ = Symbol('__topicToSubscriptionsMap__');
// symbol used to access the map of symbol to its subscription location
const __symbolToSubscriptionLocationMap__ = Symbol('__symbolToSubscriptionLocationMap__');
...
class PSub {
  ...
  subscribe(topic, handler) {
    (0, _utils.assertValidTopicAndHandler)(topic, handler);
   ...
   */
  publish(topic, ...args) {
    (0, _utils.assertValidTopic)(topic);
